    ...
    <main className="app-page-main">
      <div className="app-page-container space-y-4">
        ...
        <section className="grid gap-3 sm:grid-cols-3 lg:grid-cols-6">
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-4"><p className="text-xs font-bold text-amber-700">တကယ်ရငွေ</p><p className="mt-1 text-2xl font-black text-amber-900">{loading ? "—" : money(data?.totalPaidAmount)}</p></div>
        ...
        <section className="space-y-3">
          <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4 shadow-sm"><div className="flex flex-col gap-1 border-b border-emerald-100 pb-3 sm:flex-row sm:items-center sm:justify-between"><div><h3 className="text-lg font-black text-emerald-950">ငွေချေထားသော ဗူးများ</h3><p className="text-xs text-emerald-700">အကြွေးစာရင်းမှ ပြန်လည်ငွေချေထားသော ဗူးရောင်းစာရင်း</p></div><div className="text-left sm:text-right"><p className="text-sm font-black text-emerald-800">{Number(data?.paidBottleSales?.totalBottles || 0).toLocaleString()} ဗူး</p><p className="text-sm font-black text-emerald-800">{money(data?.paidBottleSales?.totalPaidAmount)}</p></div></div>
          <div className="mt-3">
        ...
        <section className="space-y-3">
          <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4 shadow-sm"><div className="flex flex-col gap-1 border-b border-cyan-100 pb-3 sm:flex-row sm:items-center sm:justify-between"><div><h3 className="text-lg font-black text-cyan-950">လက်ငင်းချေထားသော ဗူးများ</h3><p className="text-xs text-cyan-700">လက်ငင်းရောင်းစာရင်းထဲမှ ဗူးရောင်းအား</p></div><div className="text-left sm:text-right"><p className="text-sm font-black text-cyan-800">{Number(data?.cashBottleSales?.totalBottles || 0).toLocaleString()} ဗူး</p><p className="text-sm font-black text-cyan-800">{money(data?.cashBottleSales?.totalPaidAmount)}</p></div></div>
          <div className="mt-3">
