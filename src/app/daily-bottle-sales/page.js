    ...
    <main className="app-page-main">
      <div className="app-page-container space-y-4">
        ...
        <section className="grid gap-3 sm:grid-cols-3 lg:grid-cols-7">
          ...
          <div className="rounded-xl border border-teal-200 bg-teal-50 p-4"><p className="text-xs font-bold text-teal-700">ငွေချေဗူး (သီးသန့်)</p><p className="mt-1 text-2xl font-black text-teal-900">{loading ? "—" : Number(data?.paidBottleSales?.totalBottles || 0).toLocaleString()} ဗူး</p><p className="mt-1 text-[11px] font-bold text-teal-700">အကြွေးစာရင်းမှ ငွေချေ</p></div>
