...
function stockStatus(item) {
  if (item.currentCards < 0) return { label: "အနုတ်လက်ကျန်", className: "bg-rose-100 text-rose-800" };
  if (item.currentCards === 0) return { label: "လက်ကျန်မရှိ", className: "bg-slate-100 text-slate-700" };
