...
import { BOTTLE_GROUPS, BOTTLE_ITEMS, DEFAULT_TUBE_MAPPINGS, TUBE_BY_MACHINE, TUBE_CARD_TYPE_MAPPINGS, getBottleDisplayName, getBottleGroup, getBottleUnit, MACHINES, normalizeTubeTypes } from "@/lib/production-catalog";
...
export default function ProductionEntryPage() {
  ...
  function selectTubeCard(entry) {
    setActiveTubeKey(entry.key);
    const mappedTubeType = TUBE_CARD_TYPE_MAPPINGS[entry.label];
    if (mappedTubeType) setTubeMetrics((current) => ({ ...current, tubeType: mappedTubeType }));
  }
