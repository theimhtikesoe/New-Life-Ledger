      ...
      <div className="app-page-container app-page-surface production-container">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <div className="grid grid-cols-1 items-start gap-4 md:grid-cols-3">
            <div className="flex min-w-0 flex-col gap-2 overflow-hidden rounded-2xl border-2 border-violet-200 bg-violet-50 p-4 text-base font-black text-violet-950 shadow-sm"><span className="text-lg">အမျိုးအစား</span>{categoryLocked ? <div className="flex h-14 w-full items-center justify-between rounded-xl border-2 border-violet-300 bg-violet-100 px-3 text-lg font-black text-violet-950"><span>{category === "tube" ? "Tube" : "ဗူးခွံ"}</span><span className="rounded-full bg-violet-200 px-2 py-1 text-[11px] font-bold text-violet-700">သတ်မှတ်ထားသည်</span></div> : <ThemedSelect ariaLabel="အမျိုးအစား" value={category} onChange={(event) => handleCategoryChange(event.target.value)} className="h-14 w-full rounded-xl border-2 border-violet-300 bg-white px-3 text-lg font-black"><option value="bottle">ဗူးခွံ</option><option value="tube">Tube</option></ThemedSelect>}</div>
