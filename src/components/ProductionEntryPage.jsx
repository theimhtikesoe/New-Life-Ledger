...
export default function ProductionEntryPage() {
  ...
  const [tubeMetrics, setTubeMetrics] = useState({ usedGlueKg: "", usedGlueBags: "", remainingGlueKg: "", remainingGlueBags: "", scrapKg: "", scrapTubeCount: "", scrapGlueCount: "", tubeCountBags: "", tubeCountPcs: "", tubeDamageKg: "", glueWasteKg: "" });
  ...
  function startEdit(group) {
    ...
    setTubeMetrics(group.tubeMetrics || { usedGlueKg: "", usedGlueBags: "", remainingGlueKg: "", remainingGlueBags: "", scrapKg: "", scrapTubeCount: "", scrapGlueCount: "", tubeCountBags: "", tubeCountPcs: "", tubeDamageKg: "", glueWasteKg: "" });
    ...
    <main className="app-page-main production-page">
      <div className="app-page-container app-page-surface production-container">
        ...
        <section className="rounded-2xl border border-blue-200 bg-white p-4 shadow-sm">
          {category === "tube" ? <div className="rounded-xl border border-cyan-200 bg-cyan-50 p-3 text-sm font-black text-cyan-900">Tube အမျိုးအစားအတွက် ပူးတွဲဆင်းသူများ မသတ်မှတ်ပါ။</div> : <>
